...
#include <memory>
#include "../Interfaces/appliance.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_appliance_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_appliance_t qt_meta_stringdata_appliance = {
    {
QT_MOC_LITERAL(0, 0, 9) // "appliance"
...
QT_INIT_METAOBJECT const QMetaObject appliance::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_appliance.data,
